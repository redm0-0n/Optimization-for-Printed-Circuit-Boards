    ...
    <div className="flex-1 flex min-h-0">
      <div className="w-96 border-r border-pcb-border bg-pcb-surface/20 overflow-y-auto flex flex-col p-4 space-y-5">
        ...
        <div>
          ...
          <select value={selectedBoardId || ""} onChange={(e) => setSelectedBoardId(e.target.value)} className="w-full rounded-lg border border-pcb-border bg-pcb-surface/50 text-xs px-3 py-2 mb-3 outline-none focus:border-pcb-accent/50">
